...
# ============================================================================
# Events routes (Web UI) — defined in src/api/events_routes.py
# ============================================================================

from src.api.events_routes import register_events_routes  # noqa: E402
register_events_routes(app, require_auth, require_event_stream_auth)


# ============================================================================
# Position Decision routes (Web UI) — defined in src/api/position_routes.py
# ============================================================================

from src.api.position_routes import register_position_routes  # noqa: E402
register_position_routes(app, require_auth, require_event_stream_auth)
...
register_news_routes(app, require_auth, require_event_stream_auth)
...
register_opportunity_routes(app, require_auth, require_event_stream_auth)


# ============================================================================
# Logic Chain routes (Web UI) — defined in src/api/logic_chain_routes.py
# ============================================================================
